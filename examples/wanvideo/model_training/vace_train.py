...
from diffsynth.core import AgiBotWorldBetaDataset
...
class WanTrainingModule(DiffusionTrainingModule):
    def __init__(
        ...
        self.pipe.vace = self.pipe.create_vace_from_dit(self.pipe.dit, vace_in_dim=48, zero_init_extra=True).to(dtype=self.pipe.torch_dtype, device=self.pipe.device)
        print(self.pipe.vace.get_config())
...
def wan_parser():
    ...
    parser.add_argument("--text_dropout_prob", type=float, default=0.1, help="The dropout probability for text inputs. It can be used to improve the model's robustness to noisy text inputs.")
    return parser
...
if __name__ == "__main__":
    ...
    dataset = AgiBotWorldBetaDataset(data_root=args.dataset_base_path, split="train", 
